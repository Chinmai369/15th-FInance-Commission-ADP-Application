...
export default function EEPHDashboard({
  ...
  const openPreview = (sub) => {
    ...
    console.log("🔍 EEPH openPreview - Original sub:", sub);
    console.log("🔍 EEPH openPreview - Fresh sub from array:", freshSub);
    console.log("🔍 EEPH openPreview - Files check:", {
    ...
    console.log("🔍 EEPH openPreview - File Details:", {
    ...
    console.log("🔍 EEPH openPreview - Original sub Files:", {
  ...
  const forwardApprovedToDept = () => {
    ...
    // Set banner message
    setForwardSuccess("✅ Successfully Forwarded to SEPH Department!");
    setTimeout(() => {
      setForwardSuccess("");
    }, 5000);
  };
