...
export default function AdminDashboard({
  ...
  const [verificationData, setVerificationData] = useState(null); // Store verification details
        ...
        submissionsToForward.map(async (s, index) => {
          try {
            ...
            const converted = {
              ...
              forwardedDate: now,
              forwardedBy: user?.username || "Engineer",
              remarks: "",
              selection: {
                year: selection.year || "",
                installment: selection.installment || "",
                  ...
                  <div className="flex justify-end">
                    <button
                      onClick={() => {
                        ...
                        // Don't reset verificationConfirmed or verificationData - keep them so user can see previous verification
                      }}
                    ...
                    >
                      {verificationData ? "View Preview & Verification" : "Preview Before Forwarding"}
                    </button>
                  </div>
                </div>
              )}
